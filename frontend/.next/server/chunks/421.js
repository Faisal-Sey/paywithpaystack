...
db.user = (__webpack_require__(745)["default"])(sequelize, sequelize__WEBPACK_IMPORTED_MODULE_1__.DataTypes);
db.payment = (__webpack_require__(3652)["default"])(sequelize, sequelize__WEBPACK_IMPORTED_MODULE_1__.DataTypes);
db.sequelize.sync({
    force: false
}).then(()=>{
